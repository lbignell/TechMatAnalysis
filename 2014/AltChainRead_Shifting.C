//This file will try to do the readout of the TChain without using a TSelector
#include <fstream>
#include "TROOT.h"
#include "TFile.h"
#include "TTree.h"
...
void AltChainRead_Shifting(string fname){

  //Open the file.
  TFile* fdata = TFile::Open(fname.c_str());
  TTree* theTree = (TTree*)fdata->Get("LSChain");
